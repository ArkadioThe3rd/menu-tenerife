...
const Home = () => {
  const imagenes = {
    logo: 'https://imagenesmenutenerife.s3.amazonaws.com/Hoy+Menu%CC%81+Tenerife_Logotipo.svg',
    imgBanner1: 'https://imagenesmenutenerife.s3.amazonaws.com/Foto+1.svg',
    imgBanner2: 'https://imagenesmenutenerife.s3.amazonaws.com/Foto+2.svg',
  };
  ...
  return (
    <div className="w-full h-full overflow-y-auto scroll-behavior">
      ...
      <div className="px-28 w-full">
        <Banner
          img1={imagenes.imgBanner1}
          img2={imagenes.imgBanner2}
          img3={imagenes.imgBanner1}
          img4={imagenes.imgBanner2}
        />
